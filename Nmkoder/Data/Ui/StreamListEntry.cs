...
{
    public class StreamListEntry : ListEntryBase
    {
        ...
        /// <summary> Index of this entry's source file within the file list, or -1. </summary>
        public int GetFileIndex()
        {
            for (int i = 0; i < FileList.Items.Count; i++)
            {
                if (FileList.Items[i].File.ImportPath == MediaFile.ImportPath)
                    return i;
            }

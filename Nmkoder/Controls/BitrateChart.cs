...
namespace Nmkoder.Controls
{
    ...
    public class BitrateChart : Control
    {
        ...
        private static readonly IBrush LineBrush = new SolidColorBrush(Color.FromRgb(0x79, 0xD1, 0xC6));
        private static readonly IBrush FillBrush = new SolidColorBrush(Color.FromArgb(60, 0x79, 0xD1, 0xC6));
        ...
        private static readonly IBrush SelectionBrush = new SolidColorBrush(Color.FromArgb(56, 0x79, 0xD1, 0xC6));
